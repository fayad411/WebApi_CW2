...
cloudinary.config({
  ...
  export async function POST(req) {
    ...
    return NextResponse.json({ massge: "created successfully" }, { status: 201 });
  }
  // Updated products
  export async function PUT(req) {
    ...
    return NextResponse.json({ massge: "Updated successfully" }, { status: 200 });
  }
  // get all products
  ...
  export async function DELETE(req) {
    ...
    return NextResponse.json({ massge: "Deleted successfully" }, { status: 200 });
  }