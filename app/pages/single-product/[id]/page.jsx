  ...
  return (
    <div className="flex flex-col justify-center items-center text-center shadow-md shadow-black rounded-lg m-4">
      ...
      <div className="flex flex-col justify-center items-center">
        ...
        <div className="flex justify-between gap-9 items-center">
          <span className="text-xl  mr-4 font-mono font-bold text-left"> Cooking Time: {cookingTime}</span>
          <span className="text-xl  mr-4 font-mono font-bold text-left"> Difficulty Level: {difficultyLevel}</span>

        </div>
        <div className="flex justify-between items-start">
          <span className="text-xl font-mono font-bold text-left"> Nutrition Info : {nutritionalInfo}</span>
        </div>
        <div className="flex justify-between items-start">
          <span className="text-xl font-mono font-bold text-left"> Ingridients : {ingredients}</span>
        </div>
        <div className="flex justify-between items-start">
          <span className="text-xl font-mono font-bold text-left"> Description : {description}</span>
        </div>
      </div>
    </div>
  );
